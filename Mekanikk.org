...
*** Distansen mellom objektene
    ...
    - Vi kan nå regne ut aksellerasjonen
...
* Simulering
  - Regn ut aksellerasjonen (summer aksellerasjonen fra alle kreftene)
  - Oppdater hastigheten basert på tilbakelagt tid og aksellerasjonen
...
** Kast med liten ball
   ...
   - Hvis du får tid, kan du:
     ...
     - Legge til en forenklet luftmotstand som en kraft
       (aksellerasjonen bestemmes av hastigheten til ballen
